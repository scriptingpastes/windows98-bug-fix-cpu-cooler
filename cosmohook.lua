...
library.theme.TextColor = Color3.fromRGB(155, 123, 219)
...
function library:New(name) 
	...
	Banan.Name = "electric boogalo" 
	Banan.ResetOnSpawn = false 
	Banan.ZIndexBehavior = "Global" 
	Banan.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = Banan 
	...
	Menu.Image = "http://www.roblox.com/asset/?id=9374719259" 
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.Insert then 
			Banan.Enabled = not Banan.Enabled 
			library.uiopen = Banan.Enabled 
		end 
	end) 
	...
	do 
		...
		TextLabel.BorderColor3 = COL3RGB(155, 123, 219) 
	...
	function menu:Tab(text) 
		...
		TextButton.MouseButton1Down:Connect(function() 
			if currenttab ~= text then 
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 123, 219)}) 
				currenttab = text 
				TabGui.Visible = true 
			end 
		end) 
		...
		function Tab:MSector(text, side) 
			...
			function MSector:Tab(text) 
				...
				TextButton.MouseButton1Down:Connect(function() 
					...
					tab1.Visible = true 
					library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 123, 219)}) 
				end) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Drop.ZIndex = 5 
						Drop.ScrollBarImageColor3 = COL3RGB(155, 123, 219) 
							...
							do 
								...
								Button.MouseButton1Down:Connect(function() 
									if TBLFIND(Element.value.Jumbobox, v) then 
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 123, 219)}) 
									end 
									updatetext() 
							...
							for i,v in pairs(Drop:GetChildren()) do 
								if v.Name ~= "UIListLayout" then 
									if TBLFIND(val.Jumbobox, v.Name) then 
										v.TextLabel.TextColor3 = COL3RGB(155, 123, 219)
									else 
					...
					elseif type == "ToggleKeybind" then 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(155, 123, 219)
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(155, 123, 219)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
							else 
								keybindremove(text) 
						...
						do 
							...
							Always.Text = "Always" 
							Always.TextColor3 = COL3RGB(155, 123, 219)
							...
							for _,button in pairs(Frame:GetChildren()) do 
								if button:IsA("TextButton") then 
									button.MouseButton1Down:Connect(function() 
										...
										button.Font = Enum.Font.Code 
										button.TextColor3 = COL3RGB(155, 123, 219) 
										values[tabname][sectorname][tabtext][text] = Element.value 
										callback(Element.value) 
									end) 
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 123, 219)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
					...
					elseif type == "ToggleColor" then 
						...
						HueFrameGradient.Color = ColorSequence.new { 
							...
							ColorSequenceKeypoint.new(0.83, COL3RGB(155, 123, 219)), 
					...
					elseif type == "ToggleTrans" then 
						...
						TextLabel.Parent = Button 
						TextLabel.BackgroundColor3 = COL3RGB(155, 123, 219) 
						TextLabel.BackgroundTransparency = 1.000 
						TextLabel.Position = UDIM2(0, 32, 0, -1) 
						TextLabel.Size = UDIM2(0.111913361, 208, 1, 0) 
						TextLabel.Font = Enum.Font.Code 
						...
						Transcolor.ImageColor3 = COL3RGB(155, 123, 219) 
						Transcolor.ZIndex = 3 
					...
					elseif type == "Slider" then 
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(155, 123, 219)), ColorSequenceKeypoint.new(1, COL3RGB(155, 123, 219))} 
					...
					elseif type == "Button" then 
						...
						Button_2.MouseButton1Down:Connect(function() 
							TextLabel.TextColor3 = COL3RGB(155, 123, 219)
						...
						Button_2.MouseEnter:Connect(function() 
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 123, 219)}) 
						end) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				if type == "ScrollDrop" then 
					...
					for i,v in ipairs(joe) do 
						do 
							...
							Frame.ScrollBarImageColor3 = COL3RGB(155, 123, 219)      
								...
								for _,bad in pairs(v.Frame:GetChildren()) do      
									if bad:IsA("TextButton") then      
										...
										if bad.Name == Element.value.Scroll[v.Name] then      
											bad.TextLabel.TextColor3 = COL3RGB(155, 123, 219)     
										end      
									end      
								end      
							end      
				...
				elseif type == "Scroll" then      
					...
					function Element:SetValue(val)      
						...
						library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(155, 123, 219)})      
						values[tabname][sectorname][text] = Element.value      
						callback(Element.value)      
					end      
					values[tabname][sectorname][text] = Element.value      
				...
				elseif type == "ToggleColor" then      
					...
					Colorpick.AutoButtonColor = false      
					Colorpick.Image = "rbxassetid://4155801252"      
					Colorpick.ImageColor3 = COL3RGB(155, 123, 219)      
					Colorpick.ZIndex = 3      
				...
				elseif type == "ToggleTrans" then      
					...
					Huepick.AutoButtonColor = false      
					Huepick.Image = "rbxassetid://3641079629"      
					Huepick.ImageColor3 = COL3RGB(155, 123, 219)      
					Huepick.ImageTransparency = 1      
					Huepick.BackgroundTransparency = 0      
					Huepick.ZIndex = 3      
...
for _,lua in pairs(listfiles("cosmolua")) do 
	local luaname = GSUB(lua, "cosmolua\\", "") 
	INSERT(allluas, luaname) 
end 

RunService.RenderStepped:Wait() 

local gui = library:New("cosmohook") 
...
local credits = gui:Tab("made By coke8620")
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("cosmolua\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
...
settings:Element("Dropdown", "credits to:", {options = {"shiba.gang", "bananasense", "lunarsense (AAS)", "luckytap", "calamity", "salad.tk", "many more I can't name :)"}}) 
...
aimbot:Element("Dropdown", "automatic fire", {options = {"off", "standard", "hitpart", "gun aura"}}) 
aimbot:Element("Toggle", "autowall")  
aimbot:Element("Jumbobox", "resolver", {options = {"pitch", "front track", "roll", "animation", "offset", "bhop", "cortez step", "arm"}}) 
aimbot:Element("Slider", "offset amount", {min = -50, max = 50, default = 7})
aimbot:Element("Slider", "y amount", {min = -50, max = 50, default = 1})
aimbot:Element('Dropdown', "penetration", {options = {"extend", "infinite", "normal"}})
...
antiaim:Element("Dropdown", "yaw base", {options = {"camera", "targets", "spin", "random", "stutter", "wasd yaw base", "3 head", "anti crippin'", "unhittable"}}) 
...
antiaim:Element("Dropdown", "pitch", {options = {"none", "180v2", "180v3", "Sus_down", "Random AA", "Stormy.tech", "gay", "Dynamic", "God", "freak", "180", "down", "glitch", "random", "up", "down", "imposter", "random", "banana", "sus", "180", "funny", "bad", "bad2", "bad3", "ethereal", "cool", "cool2", "back"}}) 
...
world:Element('Dropdown', 'tracers material', {options = {'Smooth', 'Flat', 'ForceField', 'Glass', 'Electro'}})
...
UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(155, 123, 219)), ColorSequenceKeypoint.new(1, Color3.fromRGB(155, 123, 219))}
...
movement:Element("Dropdown", "type", {options = {"gyro", "cframe", "fuck", "idk", "velocity"}}) 
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "Winning" and "Get tapped or get cosmohook$$$" or "cosmohook private is the best!", false, "Innocent", false, true) 
			wait(values.misc.chat["speed (ms)"].Slider/1000) 
			 
		end 
	end 
end) 
chat:Element("Dropdown", "type", {options = {"Winning", "cosmohook"}}) 
...
RunService.RenderStepped:Connect(function(step) 
	...
	if PlayerIsAlive then 
				...
				for _,Player in pairs(Players:GetPlayers()) do 
					...
					if Player.Character and Player.Character:FindFirstChild("Humanoid") and Player.Character:FindFirstChild("Humanoid").Health > 0 and Player.Team ~= "TTT" and Player ~= LocalPlayer then 
						...
						if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "front track") then 
							Player.Character.Head.Neck.C0 = CFrame.new(0,5,-10) * CFAngles(0, 0, 0)  
							end 
						...
						if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "animation") then     
							for i2,Animation in pairs(Player.Character.Humanoid:GetPlayingAnimationTracks()) do
                                ...
                                if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "bhop") then     
                                    ...
                                    sethiddenproperty(Player.Character.Humanoid.Jump, "NetworkIsSleeping", true)
                                    sethiddenproperty(Player.Character.Humanoid, "NetworkIsSleeping", true)
                                    sethiddenproperty(Player.Character.UpperTorso.BodyVelocity, "NetworkIsSleeping", true)
                                    Player.Character.Humanoid.Jump = false 
                                    Player.Character.UpperTorso.BodyVelocity:Destroy() 
                                end
					if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "offset") then     
							Player.Character.UpperTorso.Waist.C0 = CFrame.new(0, 0.75, 0)
							Player.Character.Head.Neck.C0 = CFrame.new(0, 2.75 + values.rage.aimbot["y amount"].Slider , 0)
							Player.Character.Humanoid.MaxSlopeAngle = 0
                            Player.Character.RightUpperArm.RightShoulder.C0 = CFrame.new(2.47 + values.rage.aimbot["offset amount"].Slider, 0.749999952, -0.2)
							Player.Character.LeftUpperArm.LeftShoulder.C0 = CFrame.new(-2.47 - values.rage.ragebot["offset amount"].Slider, 0.749999952, -0.2)
                            Player.Character.RightUpperLeg.RightHip.C0 = CFrame.new(0, 1.149999952, 2.49 + values.rage.aimbot["offset amount"].Slider)
							Player.Character.LeftUpperLeg.LeftHip.C0 = CFrame.new(0, 1.149999952, -2.49 - values.rage.aimbot["offset amount"].Slider)
							end
						end     
					end

                    if TBLFIND(values.rage.aimbot.resolver.Jumbobox, "Arm") then 
                        Player.Character.LeftUpperArm.LeftShoulder.C0 = CFrame.new(0,5,-5) * CFAngles(0, 0, 0)  
                        end 
							...
							if Client.gun:FindFirstChild("Melee") and values.rage.aimbot["knifebot"].Toggle then 
								...
								for _,Hitbox in ipairs(Hitboxes) do 
									...
									if values.rage.aimbot["autowall"].Toggle then 
										...
										local Penetration = Client.gun.Penetration.Value * 0.11

                                       
										if values.rage.aimbot["penetration"].Dropdown == "extend" then 
													penetration = Client.gun.Penetration.Value * 10
												elseif values.rage.aimbot["penetration"].Dropdown == "infinite" then 
													penetration = Client.gun.Penetration.Value * 100
                                                elseif values.rage.aimbot["penetration"].Dropdown == "normal" then 
													penetration = Client.gun.Penetration.Value * 1
												end
										...
										if EndHit ~= nil and Multipliers[EndHit.Name] ~= nil and #Hits <= 4 then
											if #Hits == 0 then
												...
												if Damage >= Stats["minimum damage"].Slider then
													...
													elseif values.rage.aimbot["automatic fire"].Dropdown == "gun aura" then
														local Arguments = {
															[1] = EndHit,
															[2] = EndHit.Position,
															[3] = LocalPlayer.Character.EquippedTool.Value,
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then 
			...
			local Pitch = values.rage.angles["pitch"].Dropdown == "none" and 0 or values.rage.angles["pitch"].Dropdown == "180v2" and 2 or values.rage.angles["pitch"].Dropdown == "180v3" and -9 or values.rage.angles["pitch"].Dropdown == "God" and CamLook.X - RANDOM(-0.3, 0.3)or values.rage.angles["pitch"].Dropdown == "Random AA" and RANDOM(-99999999, 100)/100 or values.rage.angles["pitch"].Dropdown == "Dynamic" and CamLook.Y-55 or values.rage.angles["pitch"].Dropdown == "gay" and RANDOM(-30 + 1000) or values.rage.angles["pitch"].Dropdown == "Stormy.tech" and (-1 + -95) or values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "banana" and -6 or values.rage.angles["pitch"].Dropdown == "ethereal" and -6/24 -69 or values.rage.angles["pitch"].Dropdown == "sus" and -5/93 -13 or values.rage.angles["pitch"].Dropdown == "funny" and 20 or values.rage.angles["pitch"].Dropdown == "bad" and math.huge -5/0 -1 or values.rage.angles["pitch"].Dropdown == "bad2" and 23 or values.rage.angles["pitch"].Dropdown == "cool2" and -13 or values.rage.angles["pitch"].Dropdown == "cool" and 12 or values.rage.angles["pitch"].Dropdown == "back" and -92 or values.rage.angles["pitch"].Dropdown == "glitch" and (0 + -5) or values.rage.angles["pitch"].Dropdown == "negative" and -6 or values.rage.angles["pitch"].Dropdown == "freak" and 5 or values.rage.angles["pitch"].Dropdown == "zero" and 0 or values.rage.angles["pitch"].Dropdown == "imposter" and math.huge -5/0 -1 or values.rage.angles["pitch"].Dropdown == "Bodyarm" and -15 or values.rage.angles["pitch"].Dropdown == "Sus_down" and -3  or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-5674596753, 156783400)/5680985749085 or 2.5
			if values.rage.angles["extend pitch"].Toggle and (values.rage.angles["pitch"].Dropdown == "up" or values.rage.angles["pitch"].Dropdown == "down" or values.rage.angles["pitch"].Dropdown == "banana" or values.rage.angles["pitch"].Dropdown == "180") then 
				Pitch = (Pitch*2)/1.6 
			end 
	...
	for _,Player in pairs(Players:GetPlayers()) do 
		...
		if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Team ~= "TTT" and (Player.Team ~= LocalPlayer.Team or values.visuals.players.teammates.Toggle) and Player.Character:FindFirstChild("Gun") and Player.Character:FindFirstChild("Humanoid") and Player ~= LocalPlayer then 
			...
			if TBLFIND(values.visuals.players.indicators.Jumbobox, "armor") and Player:FindFirstChild("Kevlar") then 
				tbl.Armor.Color = COL3RGB(155, 123, 219) 
	...
	if method == "FireServer" and self.Name == "HitPart" then 
		...
		if values.visuals.world["bullet tracers"].Toggle then 
			coroutine.wrap(function() 
				...
				beam.Material = Enum.Material[selected == 'Smooth' and 'SmoothPlastic' or selected == 'Flat' and 'Neon' or selected == 'ForceField' and 'ForceField' or selected == 'Electro' and 'rbxassetid://446111271' or 'Glass']
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current) 
	...
	if values.misc.chat["kill say"].Toggle then 
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "cosmohook top $$$" and values.misc.chat["message"].Text or "cosmohook is the god", false, "Innocent", false, true) 
	end 
end) 
